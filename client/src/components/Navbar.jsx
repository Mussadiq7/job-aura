          ...
          <div className="container mx-auto flex flex-col pl-8 gap-3 py-5">
            ...
            <div className="py-10">
              {!user?.token ? (
                <CustomButton
                  title="Sign In"
                  containerStyles="text-blue-600 py-1.5 px-5 focus:outline-none hover:bg-blue-700 hover:text-white rounded-full text-base border border-blue-600 dark:border-blue-200"
                  onClick={() => setOpen(true)}
                />
              ) : (
